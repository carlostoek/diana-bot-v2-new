...
class TestPointsAwardedEvent:
    ...
    def test_points_awarded_validation(self):
        ...
        with pytest.raises(EventValidationError, match="Points amount must be a positive integer"):
            PointsAwardedEvent(
                user_id=123,
                points_amount=-10,
                action_type="story_completion"
        ...
        with pytest.raises(EventValidationError, match="Multiplier must be a positive number"):
            PointsAwardedEvent(
                user_id=123,
                points_amount=100,
                action_type="story_completion",
        ...
        with pytest.raises(EventValidationError, match="Action type must be a non-empty string"):
            PointsAwardedEvent(
                user_id=123,
                points_amount=100,
                action_type=""
...
class TestAchievementUnlockedEvent:
    ...
    def test_achievement_validation(self):
        ...
        with pytest.raises(EventValidationError, match="Achievement tier must be one of"):
            AchievementUnlockedEvent(
                user_id=123,
                achievement_id="test_achievement",
                achievement_name="Test Achievement",
        ...
        with pytest.raises(EventValidationError, match="Achievement ID must be a non-empty string"):
            AchievementUnlockedEvent(
                user_id=123,
                achievement_id="",
                achievement_name="Test Achievement",
...
class TestStreakUpdatedEvent:
    ...
    def test_streak_validation(self):
        ...
        with pytest.raises(EventValidationError, match="Previous count must be a non-negative integer"):
            StreakUpdatedEvent(
                user_id=123,
                streak_type="daily_login",
                previous_count=-1,
...
class TestLeaderboardChangedEvent:
    ...
    def test_leaderboard_validation(self):
        ...
        with pytest.raises(EventValidationError, match="New rank must be a positive integer"):
            LeaderboardChangedEvent(
                user_id=123,
                leaderboard_type="global",
                previous_rank=10,
