...
This module provides base Event classes and domain-specific event types
for gamification, narrative, admin, and system events following the
established interfaces and Clean Architecture principles.
"""
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'BaseEvent':
        ...
        try:
            return cls(
                ...
                _priority=EventPriority(data.get('priority', EventPriority.NORMAL.value)),
...
class StreakUpdatedEvent(BaseEvent):
    ...
    def __init__(
        ...
        payload = {
            ...
            'is_broken': is_broken,
            'streak_bonus_earned': max(0, current_streak - previous_streak) if not is_broken else 0
        }
