...
class AchievementUnlockedEvent(DomainEvent):
    ...
    def _custom_validation(self, errors: List[str]) -> None:
        ...
        if not self.achievement_category or not isinstance(
            self.achievement_category, str
        ):
...
class StreakUpdatedEvent(DomainEvent):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        priority = (
            EventPriority.HIGH
            if (streak_milestone or is_broken)
...
class LeaderboardChangedEvent(DomainEvent):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        priority = (
            EventPriority.HIGH
            if (rank_change_delta and rank_change_delta >= 10) or is_new_personal_best
            else EventPriority.NORMAL
        )
    ...
    def __init__(
        ...
        **kwargs,
        ...
        payload = {
            ...
            "next_bonus_available_at": next_bonus_available_at.isoformat()
            if next_bonus_available_at
            else None,
